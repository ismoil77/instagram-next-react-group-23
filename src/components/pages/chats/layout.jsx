            ...
            <Link key={chat.chatId} href={`/chats/${chat.chatId}`}>
              ...
              >
                {chat.receiveUserName === profile?.userName ? (
                  chat.sendUserImage ? (
                    <img
                      src={`http://37.27.29.18:8003/images/${chat.sendUserImage}`}
                  ...
                  chat.receiveUserImage ? (
                    <img
                      src={`http://37.27.29.18:8003/images/${chat.receiveUserImage}`}
                ...
                <div className="flex-1">
                  <div className="flex justify-between items-center">
                    <Link
                      href={`/profile/${chat.sendUserName === profile?.userName
                        ? chat.receiveUserId
                        : chat.sendUserId
                        }`}
                    >
