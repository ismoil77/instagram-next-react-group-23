	...
	return (
		<div className='w-full md:w-[350px] bg-[#000000] md:bg-white dark:bg-gray-900 z-[20] absolute shadow-md md:right-[15px] px-[30px] py-[10px] rounded-[10px] md:rounded-[5px] bottom-[52px] md:bottom-[300px] dark:border'>
			...
			<div className='flex items-center h-[40px] gap-[55px] text-white md:text-black dark:text-white'>
				<button
					onClick={onClose}
					className='hover:text-gray-400 dark:hover:text-gray-300 transition-all'
				>
					<svg
						...
						>
							<div className='flex gap-[10px]'>
								...
								<div className='flex flex-col'>
									<Link href={`/profile/${comment.userId}`}>
										<p className='font-semibold text-white md:text-black dark:text-white'>
											{comment.userName}
										</p>
									</Link>
									<p className='w-[150px] text-white md:text-black dark:text-gray-300'>
										{comment.comment}
									</p>
								</div>
							</div>
							...
							>
								<svg
									...
									viewBox='0 0 48 48'
									fill={
										likedComments[comment.postCommentId] ? '#ff2929' : 'none'
									}
									stroke={
										likedComments[comment.postCommentId] ? '#ff2929' : 'gray'
									}
									strokeWidth={3}
									strokeLinecap='round'
									strokeLinejoin='round'
			...
			<div className='h-[43px] border-[1px] bg-gray-300 md:border-[#dbdbdb] md:bg-[#f0f0f0] dark:bg-gray-800 dark:border-gray-700 rounded-[50px] flex justify-between items-center p-[4px] relative'>
				...
				<button
					...
					className='emojiBtn text-gray-500 dark:text-gray-300 mr-[5px] hover:text-gray-700 dark:hover:text-gray-400'
				>
					<svg
						aria-label='Смайлик'
						fill='currentColor'
