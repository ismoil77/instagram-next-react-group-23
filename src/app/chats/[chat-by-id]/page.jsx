...
export default function ChatById({ params }) {
  ...
  function renderMessage(el) {
    const baseUrl = "http://37.27.29.18:8003/images/";
  ...
  return (
    <div className="w-full absolute md:relative h-screen flex flex-col bg-white">
        ...
        <div className="flex items-center gap-3">
          ...
          {chatById &&
            chatById.filter((el) => el.userName !== profile?.userName).at(0)
              ?.userImage ? (
            <img
              src={`http://37.27.29.18:8003/images/${chatById.filter((el) => el.userName !== profile?.userName).at(0)
                ?.userImage
                }`}
              alt="Avatar"
                  ...
                  <img
                    src={
                      chatById
                        ?.filter((el) => el.userName !== profile?.userName)
                        .at(0)?.userImage
                        ? `http://37.27.29.18:8003/images/${chatById
                          .filter((el) => el.userName !== profile?.userName)
                          .at(0)?.userImage
                        }`
                        : "/imgdef.jpg"
              ...
              return (
                ...
                >
                  {!isMe &&
                    (el.userImage ? (
                      <img
                        src={`http://37.27.29.18:8003/images/${el.userImage}`}
      ...
      <div
        className={`flex items-center gap-2 border-t px-3 py-2 bg-white sticky bottom-0 ${call ? "z-0" : "z-20"
          }`}
      >
        <button
