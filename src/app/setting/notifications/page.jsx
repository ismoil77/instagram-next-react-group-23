...
const NotificationsPage = () => {
    const { data, loading, error, getSubscribers, followToUser } = useSubscribers()
        ...
        <div className="md:max-w-2xl w-full absolute md:relative z-[20] bg-white px-4 py-6">
            <div className="flex justify-start mb-6 gap-3 items-center">
                <Link href="/setting" className="md:hidden block ">
                    <button className="md:hidden block "><MoveLeft /></button>
                </Link>
                    ...
                    {data.map(({ id, userShortInfo }) => (
                        ...
                        >
                                ...
                                <Avatar
                                    src={
                                        userShortInfo.userPhoto
                                            ? `http://37.27.29.18:8003/images/${userShortInfo.userPhoto}`
                                            : "/default-avatar.png"
                                    }
                            ...
                            <button
                                ...
                                className={`px-3 py-1 text-sm rounded-md font-medium active:scale-95 transition ${userShortInfo.isSubscriber
