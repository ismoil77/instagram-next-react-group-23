...
export const useChatStore = create((set, get) => ({
	...
	getChats: async () => {
		...
		try {
			...
			const res = await fetch(
				'https://instagram-api.softclub.tj/Chat/get-chats',
				{
					method: 'GET',
					headers: {
						accept: '*/*',
	...
	getUsers: async () => {
		...
		try {
			...
			const res = await fetch(
				'https://instagram-api.softclub.tj/User/get-users?PageSize=500',
				{
					method: 'GET',
					headers: {
						accept: '*/*',
	...
	deleteChat: async chatId => {
		...
		try {
			...
			const res = await fetch(
				`https://instagram-api.softclub.tj/Chat/delete-chat?chatId=${chatId}`,
				{
					method: 'DELETE',
					headers: {
						accept: '*/*',
	...
	createChat: async receiverUserId => {
		...
		try {
			...
			const res = await fetch(
				`https://instagram-api.softclub.tj/Chat/create-chat?receiverUserId=${receiverUserId}`,
				{
					method: 'POST',
					headers: {
						accept: '*/*',
